...
function renderList(data) {
	...
	var wines = data == null ? [] : (data.wine instanceof Array ? data.wine : [data.wine]);
    //var list = data == null ? [] : data;

	$('#wineList li').remove();
	$.each(wines, function(index, eachWine) {
		$('#wineList').append('<li><a href="#" data-identity="' + eachWine.id + '">'+eachWine.name+'</a></li>');
	});
}
